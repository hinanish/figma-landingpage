      ...
      <div className="container mx-auto flex items-center justify-between py-4 px-6">
        ...
        >
          ...
          <div className="flex flex-col md:flex-row items-center md:space-x-4 space-y-4 md:space-y-0 p-4 md:p-0">
            <Button className="px-4 py-2  bg-white border border-gray-400 text-black rounded-md hover:bg-black hover:text-white">
              Login
            </Button>
            <Button className="px-4 py-2 bg-black text-white rounded-md hover:text-[#000000] hover:bg-white">
              Sign Up
            </Button>
          </div>
        </nav>
